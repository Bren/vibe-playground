...
async function addNicknamesColumn() {
    try {
        console.log('🔍 Adding Nicknames column to Google Sheet...');
        ...
        // Add header for Nicknames column (column G)
        const headerRow = rows[0] || [];
        if (headerRow.length < 7) {
            headerRow[6] = 'Nicknames';
        }
        ...
        console.log('✅ Added "Nicknames" header to column G');
        
        // Process each row and add nicknames
        ...
        for (let i = 1; i < rows.length; i++) {
            ...
            if (name && nicknameDatabase[name]) {
                ...
                processedCount++;
                console.log(`✅ Added nicknames for ${name}: ${nicknameString}`);
